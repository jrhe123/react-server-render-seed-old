...
class MerchantRefundableTransactions extends Component{
    ...
    handleChangePage = (page) => {
        ...
        this.fetchTransaction(page, this.state.transactionType);
    }
    ...
    handleTransactionTypeChange = (event, index, value) => {
        ...
        this.fetchTransaction(1, value);
    }    

    fetchTransaction = (page, transactionField) => {
        ...
        apiManager.opayApi(opay_url+'merchant/refundable_transaction_list', params, true)
            .then((response) => {
        ...
        apiManager.opayApi(opay_url+refundUrl, params, true)
            .then((response) => {
                ...
                if(res.Confirmation === 'Success'){
                    ...
                    this.fetchTransaction(this.state.currentPage, this.state.transactionType);
                }else{
                            ...
                            (<Table>
                                <TableHeader adjustForCheckbox={false} displaySelectAll={false}>
                                    <TableRow displayBorder={false}>
                                        ...
                                        <TableHeaderColumn style={tableCellStyle}>Refunded Amount</TableHeaderColumn>
                                ...
                                <TableBody displayRowCheckbox={false} showRowHover={true}>
                                        {this.state.transactionList.map((tran, idx)=>(
                                            <TableRow key={tran.GUID} selectable={false}>
                                                ...
                                                <TableRowColumn style={tableCellStyle}>${tran.DisplayRefundedAmount}</TableRowColumn>
...
export default connect()(MerchantRefundableTransactions);
